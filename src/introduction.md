...
本書は、早稲田大学 人間科学部 プログラミングII（モバイルプログラミング） の教材として作成されています。

受講する学生はプログラミング経験に差があることから、その差分を補完することを目的としています。

本書はプログラミングを初めて学ぶ方を対象に、Dart言語を通じてプログラミングの基本的な考え方と技術を習得するための教材です。ある程度のプログラミング経験がある場合は、適宜読み飛ばしていただいて構いません。
